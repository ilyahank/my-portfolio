...
const ProjectCard = ({ leftAlign, images, image, title, des, tags, url }: ProjectCardProps) => {
  ...
  return (
    ...
    >
      <div className="relative inline-flex max-w-max w-full">
        <header
          className={
        ...
        >
          <div className="w-full max-w-md px-4">
            <h2
              className={
                'mb-2 block text-left text-lg font-bold md:text-xl lg:text-3xl ' +
            ...
            <p
              className={
                'w-full max-w-xs sm:max-w-sm md:w-72 lg:w-80 rounded-lg border-2 border-background bg-card p-3 md:p-4 text-left text-xs md:text-base ' +
                (leftAlign ? 'md:text-left' : 'md:text-right')
              }
            >
              {des}
            ...
            <ul
              className={
                'flex flex-wrap cursor-default gap-2 md:gap-5 p-2 text-xs text-muted md:text-base ' +
